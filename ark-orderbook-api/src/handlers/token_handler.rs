...
mod tests {
    ...
    async fn test_get_token_handler() {
        ...
        assert_eq!(token_data.broker_id, Some("0".to_string()));
    }
    ...
    async fn test_get_tokens_by_collection_handler() {
        ...
        assert_eq!(token1.broker_id, Some("0".to_string()));
        ...
        assert_eq!(token2.broker_id, Some("0".to_string()));
    }
    ...
    async fn test_get_tokens_data() {
        ...
        assert_eq!(tokens[0].broker_id, Some("0".to_string()));
        ...
        assert_eq!(tokens[1].broker_id, Some("0".to_string()));
    }
}
