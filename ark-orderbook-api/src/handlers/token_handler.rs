...
use crate::db::query::{get_token_data, get_token_by_collection_data, get_token_history_data};
...
mod tests {
    ...
    use crate::handlers::token_handler::{get_token, get_tokens_by_collection,get_token_history};
