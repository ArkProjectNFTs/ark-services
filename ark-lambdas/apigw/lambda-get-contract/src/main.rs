//! A Lambda function to get a contract from it's address in hexadecimal representation.
//!
//! To work, this lambda expects the contract address as query string parameter "address".
//!
//! `https://.../contract?address=0x1234`
//!
use ark_dynamodb::{
