...
const manifestPath = join(
  ...
  "ark-lambdas",
  "apigw",
  "lambda-get-owner-all",
  "Cargo.toml"
);

export function getOwnerAllLambda(
  scope: cdk.Stack,
  vpc: IVpc,
  ...
  const getOwnerAllLambda = new RustFunction(scope, "get-owner-all", {
    manifestPath,
    environment: {
      RUST_BACKTRACE: "1",
    },
  ...
  getOwnerAllLambda.addToRolePolicy(
